...
if((lastPage.includes("login.php") && login == 1) || (lastPage.includes("adminPageDetail.php")) ||(lastPage.includes("http://baijialaotang.epizy.com/adminPage.php") && lastTitle != null)){
