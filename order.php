...
<body>
    ...
    <div class="allToppings">
        ...
        <div class="addSeasoning">
            ...
            <div class="topping">
                <div class="toppingText">
                    <p class="toppingName">蒜 Garlic</p>
                    <p class="toppingPrice">$0.00</p>
                </div>
                <div class="toppingCheckbox">
